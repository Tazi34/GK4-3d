...
namespace GK_4.Engine.Mesh
{
    class GeometryProvider
    {
        ...
        private static int GetMidpointIndex(Dictionary<string, int> midpointIndices, List<Vector<double>> vertices, int i0, int i1)
        {
        ...
        public static void Subdivide(List<Vector<double>> vectors, List<int> indices, bool removeSourceTriangles)
        {
        ...
        public static void Icosahedron(List<Vector<double>> vertices, List<int> indices)
        {
            ...
            vertices.AddRange(
                new[]
                {
                CreateVector.Dense(new double[]{-X, 0f, Z}),
                CreateVector.Dense(new double[]{X, 0f, Z}),
                CreateVector.Dense(new double[]{-X, 0f, -Z}),
                CreateVector.Dense(new double[]{X, 0f, -Z}),
                CreateVector.Dense(new double[]{0f, Z, X}),
                CreateVector.Dense(new double[]{0f, Z, -X}),
                CreateVector.Dense(new double[]{0f, -Z, X}),
                CreateVector.Dense(new double[]{0f, -Z, -X}),
                CreateVector.Dense(new double[]{Z, X, 0f}),
                CreateVector.Dense(new double[]{-Z, X, 0f}),
                CreateVector.Dense(new double[]{Z, -X, 0f}),
                CreateVector.Dense(new double[]{-Z, -X, 0f })
                }
